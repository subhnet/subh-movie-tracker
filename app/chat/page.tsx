  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <header className="relative">
        ...
        <div className="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl rounded-2xl border border-white/20 p-8 shadow-2xl">
          <div className="flex items-center justify-between">
            <div className="flex-1">
              <div className="inline-flex items-center gap-3 bg-white/10 backdrop-blur-sm px-5 py-2.5 rounded-full mb-4 border border-white/20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="relative group">
          ...
          <div className="relative bg-gradient-to-br from-white/90 to-white/70 backdrop-blur-xl rounded-xl p-5 border border-white/30 shadow-lg">
            ...
            <h3 className="font-bold text-gray-800 mb-2">Natural Conversation</h3>
            <p className="text-sm text-gray-600">Chat naturally about movies and get personalized responses</p>
          </div>
        </div>
        ...
        <div className="relative group">
          ...
          <div className="relative bg-gradient-to-br from-white/90 to-white/70 backdrop-blur-xl rounded-xl p-5 border border-white/30 shadow-lg">
            <div className="w-12 h-12 bg-gradient-to-br from-purple-500 to-pink-600 rounded-xl flex items-center justify-center mb-3 shadow-md">
              <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
              </svg>
            </div>
            <h3 className="font-bold text-gray-800 mb-2">Knows Your Taste</h3>
            <p className="text-sm text-gray-600">AI trained on your ratings and viewing history</p>
          </div>
        </div>
        ...
        <div className="relative group">
          ...
          <div className="relative bg-gradient-to-br from-white/90 to-white/70 backdrop-blur-xl rounded-xl p-5 border border-white/30 shadow-lg">
            <div className="w-12 h-12 bg-gradient-to-br from-pink-500 to-orange-600 rounded-xl flex items-center justify-center mb-3 shadow-md">
              <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
              </svg>
            </div>
            <h3 className="font-bold text-gray-800 mb-2">Instant Recommendations</h3>
            <p className="text-sm text-gray-600">Get smart suggestions tailored to your mood</p>
          </div>
        </div>
      </div>
      ...
      {/* Info Footer */}
      <div className="relative group">
        <div className="absolute inset-0 bg-gradient-to-br from-green-500/10 to-blue-500/10 rounded-xl blur-xl"></div>
        <div className="relative bg-gradient-to-br from-white/90 to-white/70 backdrop-blur-xl rounded-xl p-6 border border-white/30 shadow-lg">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h4 className="font-bold text-gray-800 mb-2">How to chat with CineMate</h4>
